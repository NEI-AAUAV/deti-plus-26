    ...
    <div className={cn("mb-16", className)}>
      ...
      <Reveal>
        <div className="text-center">
          ...
          <h2
            id={titleId}
            className="text-balance font-display text-3xl lowercase tracking-[0.15em] text-primary sm:text-4xl"
          >
            {title}
          </h2>

          {description ? (
            <div className="mx-auto mt-4 max-w-2xl leading-relaxed text-muted-foreground">
              {description}
            </div>
          ) : null}
        </div>
